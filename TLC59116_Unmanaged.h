...
class TLC59116_Unmanaged {
  ...
  public: // constants
    ...
    // According to datasheet, I2C address is 110(A3)(A2)(A1)(A0), (0x60 or 0d96) when all pins are pulled low
    // 11 are Unassigned, 14 available, at power up; 1 more if allcall is disabled.
    static const byte Base_Addr    = 0x60;              // 0b110xxxx   0x60  base address with all A3:0 pulled down
